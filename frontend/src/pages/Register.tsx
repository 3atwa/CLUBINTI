...
import { Eye, EyeOff, UserPlus, User, Lock, Mail, ArrowRight, Github, Twitter, Facebook, Home } from 'lucide-react';
        ...
        <div className="p-8 md:p-12">
          <div className="mb-8">
            ...
            <p className="mt-3 text-gray-600 dark:text-gray-300">
              Join our community to connect with clubs and like-minded individuals.
            </p>
          </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3 text-sm">
                <label htmlFor="terms" className="text-gray-700 dark:text-gray-300">
                  I agree to the <a href="#" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-500">Terms of Service</a> and <a href="#" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-500">Privacy Policy</a>
                </label>
              </div>
            </div>
        ...
        <div className="hidden md:block relative">
          ...
          <div className="absolute inset-0 flex flex-col justify-center p-12 text-white">
            <div className="max-w-xs mx-auto text-center">
              ...
              <p className="mb-6">
                Create your profile, join clubs that match your interests, and connect with a community of like-minded individuals.
              </p>
              <ul className="space-y-4 text-left">
                <li className="flex items-start">
                  ...
                  <p className="ml-3 text-sm">Discover clubs that match your interests and passions</p>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 h-6 w-6 rounded-full bg-white bg-opacity-20 flex items-center justify-center">
                    <svg className="h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <p className="ml-3 text-sm">Connect with like-minded individuals and build your network</p>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 h-6 w-6 rounded-full bg-white bg-opacity-20 flex items-center justify-center">
                    <svg className="h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <p className="ml-3 text-sm">Create and manage your own clubs to share your passions</p>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 h-6 w-6 rounded-full bg-white bg-opacity-20 flex items-center justify-center">
                    <svg className="h-4 w-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <p className="ml-3 text-sm">Participate in events, discussions, and activities</p>
                </li>
              </ul>
            </div>
          </div>
